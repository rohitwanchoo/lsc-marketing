      ...
      <header className="border-b border-gray-800 px-6 py-4 flex items-center justify-between sticky top-0 bg-gray-950/95 backdrop-blur z-10">
        <div className="flex items-center gap-3">
          <div className="relative">
            <div className="w-3 h-3 bg-green-500 rounded-full live-dot" />
          </div>
          <h1 className="text-lg font-bold text-white">LSC Revenue Platform</h1>
          <span className="text-xs text-gray-500 bg-gray-800 px-2 py-0.5 rounded">ORGANIC-ONLY MODE</span>
        </div>
